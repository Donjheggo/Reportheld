...
const Variants = () => {
  ...
  const formColumns = useMemo(
    ...
    [getCommonEditTextFieldProps] // include address in dependencies array
  );
...
export const CreateNewVariant = ({ open, columns, onClose, onSubmit }) => {
  ...
  return (
    <Dialog open={open}>
      <DialogTitle textAlign="center">Create New Variant</DialogTitle>
      <DialogContent>
